        ...
        <ScrollReveal delay={0.2}>
          <div className="relative max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-floating">
            <div className="relative aspect-[4/3] w-full">
              <img src={afterImage} alt="Renovirana kupaonica" className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 overflow-hidden" style={{ clipPath: `inset(0 ${100 - sliderPosition}% 0 0)` }}>
                <img src={beforeImage} alt="Kupaonica prije renovacije" className="absolute inset-0 w-full h-full object-cover" />
              </div>
              <div className="absolute top-0 bottom-0 w-1 bg-background shadow-lg z-10" style={{ left: `${sliderPosition}%`, transform: "translateX(-50%)" }}>
              ...
              <div className="absolute bottom-6 left-6 px-4 py-2 bg-foreground/90 text-background rounded-lg text-sm font-semibold">Prije</div>
              <div className="absolute bottom-6 right-6 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-semibold">Poslije</div>
